          ...
          child: BlocConsumer<ActionBloc, ActionState>(
            ...
            builder: (context, state) {
              return Container(
                  ...
                  child: state.hiitMethod == 'group'
                      ? hiitListViewExercise(state, width)
                      : normalListViewExercise(state, width));
            },
          ),
        ),
        InkWell(
...
Widget hiitListViewExercise(ActionState state, double width) {
              ...
              itemBuilder: (context, index) => Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(
                          width: width - AppDimens.dimens_70,
                          child: Divider(
...
Widget normalListViewExercise(ActionState state, double width) {
  return ListView.builder(
                          ...
                          children: [
                            InkWell(
                              onTap: () {
                                context
                                    .read<ActionBloc>()
                                    .add(AddTemporarySuperSet(newList[index]));
                              },
                              child: Container(
                                alignment: Alignment.center,
                                width: double.infinity,
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Text(
                'Submit',
                style: AppAnother.textStyleDefault(
                    AppDimens.dimens_22, AppFont.semiBold, AppColor.blackColor),
              ),
            ),
          ),
          const SizedBox(
...
String getSupersetName(String value, int index) {
  ...
  for (int i = 0;
    ...
    if (i == value.split(',')[index].split(':')[1].split(';').length - 2) {
      ...
      newValue =
          '$newValue${value.split(',')[index].split(':')[1].split(';')[i]} AND ';
    }
  }
  return newValue;
}
