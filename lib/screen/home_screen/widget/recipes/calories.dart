      ...
      child: BlocConsumer<RecipesBloc, RecipesState>(
        listener: (context, state) {
          if (state.status.isSuccess) {
            context.read<IndexCommonBloc>().add(const Validate(false));
          }
        },
...
Widget waterAdd(BuildContext context, double width, String value, DateTime here,
  ...
  return Container(
      ...
      child: Row(children: [
        SizedBox(
            width: (width - AppDimens.dimens_20 * 3 - AppDimens.dimens_30) / 2,
...
Widget caloriesWidget(double width, RecipesLoaded state, String dateTime) {
  ...
  return Column(
    children: [
      Container(
        height: width * 0.5 + AppDimens.dimens_30,
        margin: const EdgeInsets.symmetric(horizontal: AppDimens.dimens_15),
        decoration: BoxDecoration(
            color: AppColor.whiteColor,
...
Widget caloriesWidgetToday(
  ...
  return Column(
    children: [
      Container(
        height: AppDimens.dimens_30 + width * 0.5,
        width: double.infinity,
                ...
                child: Container(
                  ...
                  child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          '${AppString.hour}: ${listMealsToday[index][AppString.hour].toString().split(':')[0]}:${listMealsToday[index][AppString.hour].toString().split(':')[1]}',
                          style: AppAnother.textStyleDefault(
                              AppDimens.dimens_16,
                              AppFont.medium,
                              AppColor.blackColor),
                        ...
                        Text(
                          'Calories: ${double.parse(listMealsToday[index][AppString.calories] as String).toStringAsFixed(1)}',
                          style: AppAnother.textStyleDefault(
                              AppDimens.dimens_16,
                              AppFont.medium,
                              AppColor.blackColor),
